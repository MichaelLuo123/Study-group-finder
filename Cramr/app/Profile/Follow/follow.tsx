    ...
    <SafeAreaView style={[styles.container, { backgroundColor: backgroundColor }]}>
      ...
      <Modal animationType="fade" transparent visible={removeFollowerModalVisible} onRequestClose={handleCancelRemoveFollower}>
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: cardBackgroundColor }]}>
            <Text style={[styles.modalTitle, { color: textColor }]}>
              Remove {userToRemoveFollower?.full_name || userToRemoveFollower?.username || 'this user'} from Followers?
            </Text>
            <View style={styles.modalButtons}>
              <TouchableOpacity style={[styles.modalCancelButton, { backgroundColor: cancelButtonColor }]} onPress={handleCancelRemoveFollower}>
                <Text style={[styles.modalCancelText, { color: textColor }]}>Cancel</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.modalConfirmButton}
